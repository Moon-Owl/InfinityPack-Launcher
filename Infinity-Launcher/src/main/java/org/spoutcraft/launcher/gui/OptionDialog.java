	...
	public void actionPerformed(ActionEvent evt) {
		...
		if (id.equals("OK")) {
			...
			if ((devBuilds.isSelected() && !SettingsUtil.isDevelopmentBuild())
					|| (recBuilds.isSelected() && !SettingsUtil
							.isRecommendedBuild())) {
				cleanMods();
			}
			...
			if (buildsCombo.isEnabled()) {
				...
				if (build != null) {
					if (!build
							.equalsIgnoreCase(SettingsUtil.getSelectedBuild())) {
						cleanMods();
					}
			...
			if ((urlText.getText() != null && SettingsUtil.getCustomZipUrl() == "none")
					|| !SettingsUtil.getCustomZipUrl().equalsIgnoreCase(
							urlText.getText())) {
				SettingsUtil.setCustomZipUrl(urlText.getText());
			}

			File propFile = new File(GameUpdater.modpackDir,
					"launcher.properties");
			GameUpdater.copy(SettingsUtil.settingsFile, propFile);
			...
			if (clearCache()) {
				...
				|| id.equals(devBuilds.getText())
				|| id.equals(recBuilds.getText())) {
			updateBuildsCombo();
		}
	}
