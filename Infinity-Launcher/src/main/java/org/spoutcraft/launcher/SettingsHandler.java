...
public class SettingsHandler {
	...
	/**
	 * Constructor for the Settings/Config file. Note: The resource must be in
	 * the same package or sub package as this. If in a Sub directory the
	 * resource parameter is the path to it from this class file.
	 * 
	 * @param String
	 *            resource
	 * @param File
	 ...
	 * See {@link #setCached(Boolean) setCached(Boolean)} for more info on
	 * caching
	 * 
	...
	/**
	 * Private method that takes the InputStream and it writes it to the File
	 * out
	 * 
	 * @param InputStream
	 *            input
	...
	/**
	 * Call this method before doing anything else with SettingsHandler. The
	 * only exception to this is {@link #setCached(Boolean) setCanced(Boolean)}.
	...
	/**
	 * Private method used by {@link #flush(HashMap) flush(HashMap)} to delete
	 * the old Settings/Config file.
	 * 
	 * @param File
	 *            file
	 */
	...
	/**
	 * Returns the amount of the lines in the file. It ignores the last line if
	 * it is empty.
	 * 
