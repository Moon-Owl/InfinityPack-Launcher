...
public class ModPackYML {
	...
	private static final String FALLBACK_URL = String.format(
			"http://infinitymodpack.com/pack/%s", MODPACK_YML);
	...
	public static String getModPackIcon() {
		return Util.getResourceFile(ModPackListYML.getIconName())
				.getAbsolutePath();
	}
