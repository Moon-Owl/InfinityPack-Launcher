...
public class SystemConsoleListener {
	...
	public static File logDir = new File(PlatformUtils.getWorkingDirectory()
			+ File.separator + "logs");
	...
	public void initialize() throws Exception {
		...
		Handler fileHandler = new FileHandler(new File(logDir,
				"launcher_%g.log").getPath(), 100000, 5, true);
		...
		Handler ErrHandle = new StreamHandler(stderr,
				new ClientLoggerFormatter());
