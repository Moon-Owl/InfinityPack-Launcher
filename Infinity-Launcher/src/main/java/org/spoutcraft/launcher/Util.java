...
public class Util {
	...
	public static void addComboItem(JComboBox combobox, String label,
			String value) {
	...
	public static File getResourceFile(String filename) {
		return getResourceFile(filename, GameUpdater.modpackDir,
				ModPackListYML.currentModPackDirectory);
	}
	...
	public static File getResourceFile(String filename, File overridePath,
			File defaultPath) {
